...
# IAM Deployment Users and Groups for Dev Environment
...
output "dev_group_name" {
  value       = module.iam_deployment.dev_group_name
  description = "IAM group name for dev deployers"
}

output "dev_user_names" {
  value       = module.iam_deployment.dev_user_names
  description = "List of dev user names"
}

output "dev_access_keys_info" {
  value       = "Dev access keys created - retrieve with: terraform output -json dev_access_keys"
  description = "Information about dev access keys"
}
